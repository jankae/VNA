...
/* Private defines -----------------------------------------------------------*/
#define FPGA_AUX1_Pin GPIO_PIN_14
#define FPGA_AUX1_GPIO_Port GPIOC
#define FPGA_AUX2_Pin GPIO_PIN_15
#define FPGA_AUX2_GPIO_Port GPIOC
#define FPGA_AUX3_Pin GPIO_PIN_0
